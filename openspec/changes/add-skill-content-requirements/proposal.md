...
- **Relationship to Tessl grading.** Showing a Tessl grade before import is deferred because no usable grading exists yet. A locally-defined minimum is a different thing — a floor rather than a score — but the two would eventually have to be reconciled rather than both applied independently.
