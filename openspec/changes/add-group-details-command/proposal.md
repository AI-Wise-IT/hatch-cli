...
- **How a removed member is shown.** The group itself may be fine while a member is flagged, which import currently only warns about — and which [backlog-0001](../../../intake/backlog-0001-clean-command-and-removed-dependency-check.md) already logs as wanting a registry-side dependency check. A details view is a plausible place for that to surface first.
