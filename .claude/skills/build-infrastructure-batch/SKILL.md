...
This skill scaffolds infrastructure only — no product or use-case behavior, no new architecture decisions. If an ADR is silent on something this batch needs, stop and route it to `capture-adrs` rather than choosing silently.
